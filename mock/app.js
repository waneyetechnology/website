...
const ui = {
  en: {nav:["Intelligence","Markets","Newsroom","Archive"],status:"Live intelligence",board:"SIGNAL BOARD",research:"WANEYE RESEARCH",issue:"MARKET BRIEF",hero:"See the market<br><em>before it moves.</em>",dek:"Independent signal extraction from global reporting, structured for investors who value context over noise.",pulse:"MARKET PULSE",pulseCopy:"Composite sentiment across today’s source set.",stats:["Sources analysed","Sector signals","Risk flags"],brief:"THE BRIEF",briefTitle:"What matters now",sector:"SECTOR INTELLIGENCE",sectorTitle:"Signals across the board",risk:"RISK REGISTER",riskTitle:"Know the downside",position:"POSITIONING",positionTitle:"Act on the signal",opportunity:"Opportunities",defensive:"Defensive",forward:"FORWARD VIEW",forwardTitle:"The road ahead",short:"1—3 MONTHS",long:"6—12 MONTHS",catalyst:"CATALYST MONITOR",source:"SOURCE LEDGER",sourceTitle:"Reporting behind the view",archive:"RESEARCH ARCHIVE",archiveTitle:"Three regions. Three current reports.",archiveCopy:"Open the current analysis from each regional gh-pages API folder.",archiveButton:"Browse the reports",sectorSignal:"SECTOR SIGNAL",openAnalysis:"Open analysis",leadSignal:"LEAD SIGNAL",allHighlights:n=>`All ${n} executive highlights`,opportunityCard:"OPPORTUNITY",defensiveCard:"DEFENSIVE MOVE"},
  zh: {nav:["市场情报","市场板块","新闻中心","研究档案"],status:"实时情报",board:"信号看板",research:"WANEYE 研究",issue:"市场简报",hero:"洞察市场<br><em>先于变化。</em>",dek:"从全球财经报道中提炼独立信号，为重视背景与逻辑的投资者提供结构化市场情报。",pulse:"市场温度",pulseCopy:"基于本期全部信息源的综合情绪判断。",stats:["分析信息源","板块信号","风险提示"],brief:"市场简报",briefTitle:"当前要点",sector:"板块情报",sectorTitle:"洞察市场主线",risk:"风险评估",riskTitle:"识别下行风险",position:"策略配置",positionTitle:"将信号转化为行动",opportunity:"投资机会",defensive:"防御策略",forward:"前瞻展望",forwardTitle:"后市研判",short:"未来1—3个月",long:"未来6—12个月",catalyst:"催化剂观察",source:"信息来源",sourceTitle:"支撑研判的市场报道",archive:"研究档案",archiveTitle:"三个区域，三份当前报告。",archiveCopy:"打开各区域gh-pages API文件夹中的当前分析。",archiveButton:"浏览研究报告",sectorSignal:"板块信号",openAnalysis:"查看分析",leadSignal:"核心信号",allHighlights:n=>`完整呈现${n}项核心摘要`,opportunityCard:"投资机会",defensiveCard:"防御策略"}
};
...
function applyLocale() {
  ...
  $$('[data-edition]').forEach(a=>a.setAttribute('aria-current',a.dataset.edition===region?'page':'false'));
...
function render() {
  ...
  $("#newsList").innerHTML = r.news.slice(0,5).map(n => `<a class="news-item" href="newsroom/article.html?region=${region}&id=${n.index}"><span class="news-index">#${String(n.index).padStart(3,"0")}</span><h3>${n.title}</h3><span class="news-source">${n.source}</span><span class="news-date">${n.publishedAt}</span><b>↗</b></a>`).join("");
}
